            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
                ...
                <div class="menuBotones ml-auto">
                    <ul class="navbar-nav flex-row mt-4">
                        ...
                        <li class="nav-item ml-auto">
                            <a href="{{ route('logout')}}" class="nav-link d-none d-lg-inline-block logout" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();"><i class="fas fa-sign-out-alt"></i> Cerrar Sesión</a>
