<nav class="navbar navbar-expand-md navbar-dark fixed-top" id="navbar-edit">
	<div class="container-fluid d-flex flex-column">
		...
		<div class="menuBotones container">
			<ul class="navbar-nav d-flex justify-content-around">
				@php
				$categorias = array('FUENTES', 'PLACAS DE VIDEO', 'MEMORIAS RAM', 'MOTHERBOARDS', 'PROCESADORES', 'GABINETES', 'MONITORES');
				@endphp

				@foreach ($categorias as $categoria)
				<li class="nav-item">
					<a href="#" class="nav-link d-none d-lg-inline-block" style="font-size: 1.3em"><strong>{{$categoria}}</strong></a>
				</li>
				@endforeach
			</ul>
		</div>
